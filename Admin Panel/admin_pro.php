    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Admin Profile</h1>
                <a href="" class="h4 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Admin Profile</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
                                ...
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <div class="col-12 col-sm-12">
                                        ...
                                        <div id="image-container">
                                            <img id="selected-image" src="<?php echo 'userimg/' . $row['aImage'] ?>"
                                    ...
                                    <!-- <div class="col-12 col-sm-6">
                                        <input type="phone" name="apassword" class="form-control bg-light border-0 "
                                            value="<?php echo $row['apassword'] ?>" style="height: 55px;">
                                    </div> -->
                                    <div class="col-12">
